...
typedef struct {
    ...
    void (*on_batch_log)(int batch, int total_batches, float loss, int samples_processed);
    void (*on_epoch_end)(int epoch, float avg_loss, float val_loss, float val_acc, int improved, const char *saved_path);
